 ...
 * Modal selector for structured Grade / Class selection (Grades 6–12).
...
import { GradeValue } from '../../features/auth';
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        accessibilityLabel={t.grade}
        accessibilityHint={value ? `Selected ${value}. Double tap to change.` : t.gradePlaceholder}
      >
        <Text style={styles.leadingIcon}>🎓</Text>
        <Text style={[styles.triggerText, !value && styles.placeholderText]}>
          {value || t.gradePlaceholder}
        </Text>
            ...
            <TouchableWithoutFeedback>
              <View style={styles.modalCard}>
                <View style={styles.modalHeader}>
                  <Text style={styles.modalTitle}>{t.grade}</Text>
                  <TouchableOpacity

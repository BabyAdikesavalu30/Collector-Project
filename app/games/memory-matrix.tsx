/**
 * Memory Matrix Game Screen (/games/memory-matrix)
 * Game 10: Science card flip and memory matching.
 */
...
import { useMemoryMatrixGame } from '../../src/features/games/memory-matrix';
...
export default function MemoryMatrixGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('memory-matrix');
    setProgress(p);
  }, []);

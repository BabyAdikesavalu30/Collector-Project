/**
 * Mini Sudoku Game Screen (/games/mini-sudoku)
 * Game 4: The classic game, made mini with 15 levels and level selection.
 */
...
import { useSudokuGame } from '../../src/features/games/sudoku';
...
export default function MiniSudokuGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('mini-sudoku');
    setProgress(p);
  }, []);

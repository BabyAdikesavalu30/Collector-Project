/**
 * Pattern Lab Game Screen (/games/pattern-lab)
 * Game 14: Deduce scientific sequences, orbital laws, and mathematical patterns.
 */
...
import { usePatternLabGame } from '../../src/features/games/pattern-lab';
...
export default function PatternLabGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('pattern-lab');
    setProgress(p);
  }, []);
    ...
    <View style={styles.container}>
      ...
      >
        <PatternLabBoard
          ...
          language={language}
          chooseOptionLabel={gameT.chooseOption}
        />
      </ScrollView>

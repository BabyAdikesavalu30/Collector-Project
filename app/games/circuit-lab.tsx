/**
 * Circuit Lab Game Screen (/games/circuit-lab)
 * Game 9: Assemble working closed electrical circuits.
 */
...
import { useCircuitLabGame } from '../../src/features/games/circuit-lab';
...
export default function CircuitLabGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('circuit-lab');
    setProgress(p);
  }, []);

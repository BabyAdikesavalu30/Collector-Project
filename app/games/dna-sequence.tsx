/**
 * DNA Sequence Game Screen (/games/dna-sequence)
 * Game 19: Genetic pairing and RNA transcription.
 */
...
import { useDnaSequenceGame } from '../../src/features/games/dna-sequence';
...
export default function DnaSequenceGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('dna-sequence');
    setProgress(p);
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <DnaSequenceBoard
          level={level}
          playerStrand={playerStrand}
          activeSlotIndex={activeSlotIndex}
          onSelectBase={handleSelectBase}
          onUndo={handleUndo}
          language={language}
          templateLabel={gameT.templateStrand}
          complementLabel={gameT.complementStrand}
        />
      </ScrollView>

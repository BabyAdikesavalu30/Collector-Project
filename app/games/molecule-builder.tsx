/**
 * Molecule Builder Game Screen (/games/molecule-builder)
 * Game 8: Construct molecules with valid chemical stoichiometry.
 */
...
export default function MoleculeBuilderGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('molecule-builder');
    setProgress(p);
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <MoleculeBuilderBoard
          formula={level.targetFormula}
          chemicalName={level.targetName}
          selectedAtoms={selectedAtoms}
          availableAtoms={level.availableAtoms}
          onAddAtom={handleAddAtom}
          onRemoveAtom={handleRemoveAtom}
          language={language}
          targetLabel={gameT.targetMolecule}
          bondedLabel={gameT.bondedAtoms}
          trayLabel={gameT.atomTray}
        />
      </ScrollView>

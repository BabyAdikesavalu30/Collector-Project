/**
 * Element Match Game Screen (/games/element-match)
 * Game 7: Match chemical element symbols with names.
 */
...
import { useElementMatchGame } from '../../src/features/games/element-match';
...
export default function ElementMatchGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('element-match');
    setProgress(p);
  }, []);
    ...
    <View style={styles.container}>
      ...
      >
        <ElementMatchBoard
          ...
          symbolsLabel={gameT.symbols}
          namesLabel={gameT.names}
          language={language}
        />
      </ScrollView>

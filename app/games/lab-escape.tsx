/**
 * Lab Escape Game Screen (/games/lab-escape)
 * Game 17: Multi-stage science escape room sequences.
 */
...
import { useLabEscapeGame } from '../../src/features/games/lab-escape';
...
export default function LabEscapeGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('lab-escape');
    setProgress(p);
  }, []);

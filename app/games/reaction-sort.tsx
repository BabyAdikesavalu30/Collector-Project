/**
 * Reaction Sort Game Screen (/games/reaction-sort)
 * Game 12: Sort chemical items, acids/bases, and reactions.
 */
...
import { useReactionSortGame } from '../../src/features/games/reaction-sort';
...
export default function ReactionSortGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('reaction-sort');
    setProgress(p);
  }, []);
    ...
    <View style={styles.container}>
      ...
      >
        <ReactionSortBoard
          ...
          sortedCount={currentItemIndex}
          totalItems={level.items.length}
          feedback={lastFeedback}
          onSelectCategory={handleSortItem}
          language={language}
          sortPrompt={gameT.sortPrompt}
        />
      </ScrollView>

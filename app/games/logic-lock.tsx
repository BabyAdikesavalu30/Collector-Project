/**
 * Logic Lock Game Screen (/games/logic-lock)
 * Game 15: Deduce multi-dial secret vault codes.
 */
...
import { useLogicLockGame } from '../../src/features/games/logic-lock';
...
export default function LogicLockGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('logic-lock');
    setProgress(p);
  }, []);
    ...
    <View style={styles.container}>
      ...
      >
        <LogicLockBoard
          ...
          language={language}
          cluesTitle={gameT.cluesTitle}
          checkCodeLabel={gameT.checkCode}
        />
      </ScrollView>

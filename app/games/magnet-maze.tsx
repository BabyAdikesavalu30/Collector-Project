/**
 * Magnet Maze Game Screen (/games/magnet-maze)
 * Game 20: Magnetic particle navigation with polar attraction and repulsion.
 */
...
import { useMagnetMazeGame } from '../../src/features/games/magnet-maze';
...
export default function MagnetMazeGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('magnet-maze');
    setProgress(p);
  }, []);
    ...
    <View style={styles.container}>
      ...
      >
        <MagnetMazeBoard
          ...
          onTogglePole={handleTogglePole}
          language={language}
          polarityLabel={gameT.polarityLabel}
          togglePolarityLabel={gameT.togglePolarity}
        />
      </ScrollView>

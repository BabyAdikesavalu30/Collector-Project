/**
 * Time Machine Game Screen (/games/time-machine)
...
export default function TimeMachineGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('time-machine');
    setProgress(p);
  }, []);
    ...
    <View style={styles.container}>
      ...
      >
        <TimeMachineBoard
          ...
          onVerifyTimeline={handleVerifyTimeline}
          language={language}
          verifyTimelineLabel={gameT.verifyTimeline}
        />
      </ScrollView>

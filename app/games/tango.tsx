/**
 * Tango Game Screen (/games/tango)
 * Game 5: Harmonize the grid with 15 levels and level selection.
 */
...
import { useTangoGame } from '../../src/features/games/tango';
...
export default function TangoGameRoute() {
  ...
  const loadProgress = useCallback(async () => {
    const p = await getGameProgress('tango');
    setProgress(p);
  }, []);
    ...
    <View style={styles.container}>
      ...
      >
        <TangoBoard
          ...
          legendSun={gameT.sun}
          legendMoon={gameT.moon}
          legendEqual={gameT.equal}
          legendOpposite={gameT.opposite}
        />
      </ScrollView>
